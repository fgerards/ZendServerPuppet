...
define zendserver::vhost::addsecure (
  ...
  $required_options        = "--name=${downcase_vhostname} --port=${port} --sslCertificatePath=${sslCertificatePath} --sslCertificateKeyPath=${sslCertificateKeyPath}"
